...
// Internal snapshots retain a normal module plus exact sample/header/keymap
// and optional envelope corrections. Ordinary module export never writes this container.
