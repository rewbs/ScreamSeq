...
inline std::vector<std::filesystem::path> chooseSampleFiles(HWND owner,const wchar_t *title,bool multiple=false) {
  ...
  choice.lpstrFilter=L"Audio samples\0*.wav;*.aif;*.aiff;*.flac;*.ogg;*.mp3;*.its;*.s3i;*.xi\0All files\0*.*\0\0";
